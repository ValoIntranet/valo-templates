...
module.exports = class extends Generator {
  ...
  installCoreDependencies() {
    ...
    this.npmInstall(["typescript", "gulp", "fs", "gulp-util", "merge-stream", "gulp-concat", "gulp-typescript", "node-sass", "gulp-sass", "gulp-spsync-creds", "@types/request-promise@^3.0.32", "gulp-watch", "yargs"], { "save-dev": true });
